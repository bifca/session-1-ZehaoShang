...
$accessKey = '3d07712f38d643d39b070473e7e217f7';
...
function BingNewsSearch($url, $key, $query) {
	...
	$result = file_get_contents($url . "?setLang=en-gb&count=6&q=" . urlencode($query), false, $context);
